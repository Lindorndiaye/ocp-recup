    ...
    <div id="wrapper">
        ...
        <div class="content-page" style="margin-left:15px; margin-top:-100px;">
            ...
            <tr>
                ...
                <td style="font-size:12px;"><b><?php echo $Enseignant->deniere_diplome; ?></b></td>
                <td style="font-size:12px;"><b><?php echo $Enseignant->année_exper; ?></b></td>
                <td style="font-size:12px;"><b><?php echo $Enseignant->experience; ?></b></td>
                <td style="font-size:12px;"><b><?php echo $Enseignant->num_cni; ?></b></td>
