...
<html class="ie" xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-US" lang="en-US">
    ...
    <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-US" lang="en-US">
        ...
        <head>
            ...
            <title>OCP</title>
            <!-- Bootstrap  -->
            <link rel="stylesheet" type="text/css" rel="stylesheets" href="<?php echo e(asset('css/bootstrap.css')); ?>">
            <!-- Theme Style -->
            <link rel="stylesheet" type="text/css" rel="stylesheets" href="<?php echo e(asset('css/formu.css')); ?>">
            <link href="stylesheets/magic-check.css" rel="stylesheet">
            <link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php echo e(asset('assetss/ico/apple-touch-icon-144-precomposed.png')); ?>">
    ...
    <div style="font-size:25px; padding-top:5px; padding-bottom:25px;" class="logo-title  wow fadeInUp" data-wow-delay="0.8s" > <a href="/"><a href="/"> <img src="<?php echo e(asset('/img/Logo_OIF.jpg')); ?>" alt="" style="width:120px;"> </a><span style="font-size:25px; color:green;" class="fa  fa-calendar"></span> </a> </div>                                
        ...
        <h6> <?php if(session('message')): ?>
            ...
            <main class="content" role="content" style="margin-top:-70px;">
                <section id="section1">
                    <div class="container-fluid col-md-6 col-md-offset-3">
                        <!-- MultiStep Form -->
                        <form id="regForm" method="post" action="<?php echo e(route('entreprise.ajouter')); ?>" enctype="multipart/form-data">
            ...
            <script src="<?php echo e(asset('js/formu.js')); ?>"></script>
