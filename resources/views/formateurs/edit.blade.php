...
@section('content')
    ...
    {!! Form::open(['id' => 'dataForm', 'method' => 'PATCH', 'url' => '/formateurs/' . $formateur->id ]) !!}
    <div class="form-group">
        {!! Form::label('prenom', 'Prenom'); !!}
        {!! Form::text('prenom', $formateur->prenom ,['class' => 'form-control']); !!}
    </div>
    <div class="form-group">
        {!! Form::label('nom', 'Nom'); !!}
        {!! Form::text('nom', $formateur->nom ,['class' => 'form-control']); !!}
    </div>
    <div class="form-group">
        {!! Form::label('age', 'Age'); !!}
        {!! Form::number('age', $formateur->age ,['class' => 'form-control']); !!}
    </div>
    <div class="form-group">
        {!! Form::label('mobile', 'Telephone'); !!}
        {!! Form::text('mobile', $formateur->mobile ,['class' => 'form-control']); !!}
    </div>
    <div class="form-group">
        {!! Form::label('email', 'Email') !!}
        {!! Form::email('email', $formateur->email, ['placeholder' => 'Enter email', 'class' => 'form-control']); !!}
    </div>
...
<div class="form-group">
        ...
        {!! Form::text('ville', $formateur->ville, ['class' => 'form-control']); !!}
    </div>
    <!-- <div class="form-group">
