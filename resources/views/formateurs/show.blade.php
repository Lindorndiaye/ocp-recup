                        ...
                        <div class="col-md-12" >
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Le formateur: {!! $formateur->prenom !!} {!! $formateur->nom !!}</h3>
                                </div>

                                <tr>
                                    <td><b><embed src="{{url('images',$formateur->file) }}" style="width:980px; height:800px"></b></td>
                                    <td><b><embed src="{{url('images',$formateur->carte) }}" style="width:980px; height:800px"></b></td>
                                ...
                                <video controls width="500">
                                    ...
                                    <source src="{{url('images',$formateur->carte) }}"
                                            type="video/mp4">
                                            
                                </video>
                                <a href="{{url('images',$formateur->carte) }}" rel="nofollow">Download</a>
